...
def tournament_winner(competitions, results):
    ...
    for indx, competition in enumerate(competitions):
        winner = competition[results[indx] - 1]
        winner_points = score_board.get(winner, 0)
        score_board[winner] = winner_points + 1
            
        if max_score < score_board[winner]:
            max_score = score_board[winner]
            max_scorer = winner
...
def test_tournament_winner(competitions, results, expected):
